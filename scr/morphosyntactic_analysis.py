    ...
    if args.lemmatizer:
        for review in corpus['reviews'] :
            ...
            review['review_body'] = " ".join(
                [token.lemma_ for token in traitement])
        ...
        for review in corpus['reviews'] :
            ...
            review['review_body'] =" ".join([
                        token.lemma_ + "_" +
                        token.pos_ for token in traitement])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="morphosyntaxic analysis")
    parser.add_argument("-c", "--csv", action="store_true",
                        help="output en csv")
    parser.add_argument("-l", "--lemmatizer", action="store_true",
                        help="lemmatize only")
